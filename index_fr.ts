export default {
    ...
    form: {
      ...
      freq_trav_pro_local: "Dans quelle mesure devez-vous effectuer des déplacements locaux dans le cadre de votre travail?",
      freq_trav_pro_region: "Dans quelle mesure devez-vous effectuer des déplacements nationaux dans le cadre de votre travail?",
      freq_trav_pro_inter: "Dans quelle mesure devez-vous effectuer des déplacements internationaux dans le cadre de votre travail?",
      ...
      freq_mod_pro: "A quelle fréquence utilisez vous les modes suivants pour vos déplacements professionnels?",
      importance: "Quelle est l'importance des aspectys suivants pour vous, dans votre mobilité quotidienne?",
      ...
      needs: "Dans quelle mesure les modes de transport suivants sont-ils adaptés à vos besoins de mobilité quotidienne?",
      ...
      comments: "Merci! Avez-vous des commentaires sur ce questionnaire ou sur la démarche de plan de mobilité?",
      recommendations: "Les modes de transport suivants sont recommandés pour vos déplacements domicile-travail",
      recommendations_pro: "Les modes de transports suivants sont recommandés pour vos déplacements professionnels",
      actions: "Pas de mesures | La mesure de votre employeur: {actions} | Les mesures de votre employeur: {actions}",
    },
    main_mode: {
      ...
      combined: "Actuellement, vous vous rendez au travail avec une combinaison de modes de transport.",
      sustainable:
      ...
      actions: "Votre employeur met en oeuvre les mesures suivantes afin de promouvoir la mobilité durable",
    },
    reco: {
    ...
    actions: {
      ...
      cff_pass_ag: "Contribution à l'abonnement général de train",
      ...
      bike_subs: "Contribution à l'achat d'un vélo ou vélo électrique",
      ...
      train_pro: "AContribution à l'abonnement général de train",
      ev_fleet: "Flotte de véhicules électriques pour les déplacements professionnels",
    },
    benefits: {
      ben_bike: "Les atouts du vélo: -	La part du vélo dans les déplacements pendulaires a augmenté de 43% entre 2015 et 2021 sur le canton de Genève [MRMT] -	Aller au travail en vélo diminue en moyenne de 10% le risque de mortalité et 30% le taux de mortalité lié à un cancer [OMS]",
      ben_walk: "Les atouts de la marche: -	Aller au travail en marchant diminue en moyenne de 10% le risque de maladie cardiovasculaire et 30% le risque de diabète de type II [OMS] -	Plus de 20% des résidents du canton de Genève vont au travail en marchant, alors : pourquoi pas vous? [MRMT]",
      ben_train: "Les atouts du train: -	Lire un bon livre, traiter ses mails, ou simplement rêvasser: le train est le mode de transport pour lequel on utilise le mieux son temps de déplacement [Modus] -	Voyager en train émet en moyenne 25 fois moins de gaz à effet de serre que seul en voiture [ADEME]",
      ben_pub: "Les atouts des transports publics: -	La Suisse obtient de loin les meilleurs résultats européens en termes de ponctualité, de densité du réseau et de densité d'offre de transport public [LITRA] -	Voyager en transport public émet en moyenne 5 fois moins de gaz à effet de serre que seul en voiture [ADEME]",
      ben_elec: "Les atouts du véhicule électrique: -	Une voiture électrique légère ou compacte émet 2,3 fois moins par km qu'une voiture thermique [ADEME] -	Les véhicules électriques permettent également de réduire les nuisances sonores et la pollution atmosphérique en ville ",
      ben_carpool: "Les atouts du covoiturage: -	Covoiturer, c'est diviser par le nombre d'occupants ses émissions, mais aussi toutes les externalités de la voiture (congestion, pollution, bruit) -	Hé Léman, Illicov, covoiturage-leman.org, e-covoiturage.ch, mov'ici… Les initiatives pour favoriser le covoiturage se développent à grands pas, en parallèle de politiques favorables (P+R, voies réservées)",
      ben_inter: "Les atouts de l'intermodalité: -	De plus en plus d'offres voient le jour pour faciliter l'intermodalité (offre transport public-vélo en libre-service, vélostation dans les gares, abonnements P+R…) -	Faire une partie de son trajet de manière décarbonée et/ou active fait déjà une différence : chaque kilomètre compte lorsqu'il s'agit des bienfaits pour la santé et/ou l'environnement",
    },
    ...
    welcome_intro: "Veuillez remplir ce questionnaire afin de pouvoir vous proposer les mesures de mobilité les plus pertinentes pour vous",
